...
local SitOnEntsMode = CreateConVar("sitting_ent_mode","0", {FCVAR_NOTIFY, FCVAR_ARCHIVE})
RunConsoleCommand( 'sitting_ent_mode', '0' )
--[[
...
local AllowGroundSit = CreateConVar("sitting_allow_ground_sit","0",{FCVAR_NOTIFY, FCVAR_ARCHIVE})
