...
function SWEP:Precache()
	...
	util.PrecacheSound("weapons/ar_impact.wav")
    	util.PrecacheModel("models/weapons/v_legen_t.mdl")
	util.PrecacheModel("models/weapons/w_legen_t.mdl")
end
...
SWEP.ViewModel			= "models/weapons/v_legen_t.mdl"
SWEP.WorldModel			= "models/weapons/w_legen_t.mdl"
