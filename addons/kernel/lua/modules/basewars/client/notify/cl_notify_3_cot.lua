...
AMB.UI.Notify.RegisterNotify( 3, 'Official Capture Of Terra Notify', 'AMBITION', function( tVars )
    ...
    local textw         = UT.GetTextSizeX( text, '20 Ambition' )
    ...
    if id then
        ...
        local notify = AMB.UI.GUI.DrawPanel( nil, 12 + textw, 32, w + 28, y, function( self, w, h ) 
