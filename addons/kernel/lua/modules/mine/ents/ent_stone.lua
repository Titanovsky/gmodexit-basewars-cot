...
ENT.Stats = {
    ...
    module = 'mine',
    color_name = Color( 191, 191, 191 ),
    date = '15.04.2021 22:00:54'
...
if CLIENT then
    ...
    function ENT:DrawTranslucent()
        ...
        cam.Start3D2D( center + Vector( 0, 0, 12 ), Angle( 0, rot, 90 ), 0.1 )
            ...
            draw.SimpleTextOutlined( self.PrintName, '32 Ambition', 4, 0, C.AMB_GRAY, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 1, C.ABS_BLACK )
