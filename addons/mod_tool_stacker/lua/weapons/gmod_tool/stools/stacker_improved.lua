...
local mode = 'stacker_improved' -- defined by the name of this file (default should be stacker_improved)
...
local prefix = "#tool.stacker_improved."                            -- prefix used for this tool's localization tokens

-- needed for various stacker functionality
include( "improvedstacker/improvedstacker.lua" )
improvedstacker.Initialize( 'stacker_improved' )
